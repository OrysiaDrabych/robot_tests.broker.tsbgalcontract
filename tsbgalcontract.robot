...
Library  Collections
Library  tsbgalcontract_service.py
...
Підготувати клієнт для користувача
  ...
  Run Keyword If  '${username}' != 'tsbgalcontract_Viewer'  Login  ${username}
...
Завантажити документ
  ...
  tsbgalcontract.Пошук тендера по ідентифікатору  ${username}  ${TENDER}
...
Скасувати закупівлю
  ...
  tsbgalcontract.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid} 
...
Отримати інформацію із предмету
  ...
  ${return_value}=  Run Keyword If  '${field_name}' == 'contractPeriod.startDate'  tsbgalcontract_service.convert_DMY_ISO  ${return_value}
  ...  ELSE IF  '${field_name}' == 'contractPeriod.endDate'  tsbgalcontract_service.convert_DMY_ISO  ${return_value}
...
Отримати інформацію про items[${index}].contractPeriod.startDate
  ...
  ${return_value}=  tsbgalcontract_service.convert_DMY_ISO  ${date_value}
  [return]  ${return_value}
...
Отримати інформацію про items[0].deliveryDate.endDate
  ...
  ${return_value}=  tsbgalcontract_service.convert_date  ${date_value}
  [return]  ${return_value}
...
Додати предмет закупівлі
  ...
  tsbgalcontract.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
  ${index}=  tsbgalcontract.Отримати кількість предметів в тендері  ${username}  ${tender_uaid}
...
Дискваліфікувати постачальника
  ...
  tsbgalcontract.Оновити сторінку з тендером  ${username}  ${tender_uaid}
  ${award_index}=  inc  ${award_index}
